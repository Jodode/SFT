...
namespace pcpp
{
	...
	/**
	 * @return PcapPlusPlus long version string which include the version and info whether it's an official or non-official release. For example: "v22.11+ (non-official release)"

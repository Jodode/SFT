...
#define PCPP_HTTP_SERVER_FIELD				"Server"
	...
	/**
	 * @class HttpRequestFirstLine
	 * Represents an HTTP request header first line. The first line include 3 parameters: HTTP method (e.g GET, POST, etc.),
	...
	/**
	 * @class HttpResponseFirstLine
	 * Represents an HTTP response header first line. The first line include 2 parameters: status code (e.g 200 OK, 404 Not Found, etc.),

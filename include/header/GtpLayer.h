...
#pragma pack(pop)
	...
	public:
		...
		public:
			...
			/**
			 * @return A byte array that include the extension's content. The length of this array can be determined by
		 ...
		 * gtpv1_header#messageLength and for GTP-U the size only include the GTP header itself (meaning

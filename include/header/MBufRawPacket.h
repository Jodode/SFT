...
namespace pcpp
{
	...
	public:
		 ...
		 * Initialization include allocating an mbuf from the pool that resides in DpdkDevice.
		 ...
		 * Initialization include allocating an mbuf from the pool that resides in KniDevice.
		 * The user should call this method only once per instance.
		 * Calling it more than once will result with an error
		 ...
		 * Initialization include allocating an mbuf from the pool that resides in provided DpdkDevice,
		...
		/**
		 * @brief Initialize an instance of this class and copies the content of a RawPacket object.
		 * Initialization include allocating an mbuf from the pool that resides in provided KniDevice,
		 * and copying the data from the input RawPacket object into this mBuf.
		 * The user should call this method only once per instance.
		 * Calling it more than once will result with an error
		 * @param[in] rawPacket A pointer to a RawPacket object from which data will be copied
